...
public class eCAMShift extends EventFilter2D implements FrameAnnotater {
    ...
    // eCAMShift class constructor
    public eCAMShift(AEChip chip) {
        super(chip);
        this.chip = chip;
    ...
    synchronized public void resetFilter() {
        ...
        log.warning("eCAMShift has been reset");
    }
